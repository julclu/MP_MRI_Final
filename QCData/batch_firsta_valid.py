...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir",      required=False,    help="Path where output files get written ")
    ...
    for index, row in bnum_tnum_df.iterrows():
        ...
        if len(vial_files)>0 and first_path != None: 
            ...
            for vial in vial_files: 
                ...
                hematoma  = input('Is this biopsy in a hematoma?       (y/n/m): ')
                ventricle = input('Is this biopsy in a ventricle?      (y/n/m): ')
                dura      = input('Is this biopsy outside perfusion?   (y/n/m): ')
                distortion= input('Is there distortion?                (y/n/m): ')
                notes     = input('Additional notes                           : ')
                perf_valid_file.write(bnum+","+tnum+","+vial+","+hematoma+","+ventricle+","+dura+","+distortion+","+notes+"\n")
